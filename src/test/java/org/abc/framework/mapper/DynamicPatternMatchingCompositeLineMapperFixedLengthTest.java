...
@ContextConfiguration("DynamicPatternMatchingCompositeLineMapper_Fixed_Length.xml")
public class DynamicPatternMatchingCompositeLineMapperFixedLengthTest extends TestCase
{
	@Autowired
	protected Job job;
